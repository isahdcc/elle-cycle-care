...
const EntryScreen = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center bg-background px-6 pt-10 pb-8">
      ...
      >
        <img src={logo} alt="DiagnELAs" className="w-28 h-28 object-contain mb-2" />
      </motion.div>
      ...
      >
        ...
        <div className="text-center space-y-2">
          <p className="text-sm text-muted-foreground">
            Não tem uma conta?{" "}
            <button onClick={() => navigate("/cadastro")} className="text-primary font-display font-bold">Criar Conta</button>
          </p>
          <p className="text-sm text-muted-foreground">
            É uma clínica?{" "}
            <button onClick={() => navigate("/clinica/cadastro")} className="text-primary font-display font-bold">Cadastrar Clínica</button>
          </p>
        </div>
      </motion.div>
    </div>
